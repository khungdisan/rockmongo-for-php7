...
// $MONGO["servers"][$i]["mongo_db"] = "iptv_platform_services";//default mongo db to connect, works only if mongo_auth=false
$MONGO["servers"][$i]["mongo_user"] = "admin";//mongo authentication user name, works only if mongo_auth=false
$MONGO["servers"][$i]["mongo_pass"] = "1234567890";//mongo authentication password, works only if mongo_auth=false
